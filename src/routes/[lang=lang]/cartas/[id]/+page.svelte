...
if (!document.getElementById("monocle-embedIframe")){
  ...
  handleIframeLoad();
    ...
    if (errorElement && errorElement.textContent.includes("Error")) {
        errorElement.textContent = "Si la imagen no se carga, intente recargar la página. Si está usando un bloqueador de anuncios, intente desactivarlo para este sitio. Si el problema persiste, intente cambiar de navegador.";
...
<div id="comparisons" style="display:none">
	...
	<div id="btnsfr" style="width:100%;margin:0.5rem 1rem .5rem 5%;float:right;display:flex;justify-content: flex-end;flex-wrap: wrap;">
		<button class="btn-row" type="button" onclick="hide()"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2024 Fonticons, Inc. --><path d="M160 96a96 96 0 1 1 192 0A96 96 0 1 1 160 96zm80 152l0 264-48.4-24.2c-20.9-10.4-43.5-17-66.8-19.3l-96-9.6C12.5 457.2 0 443.5 0 427L0 224c0-17.7 14.3-32 32-32l30.3 0c63.6 0 125.6 19.6 177.7 56zm32 264l0-264c52.1-36.4 114.1-56 177.7-56l30.3 0c17.7 0 32 14.3 32 32l0 203c0 16.4-12.5 30.2-28.8 31.8l-96 9.6c-23.2 2.3-45.9 8.9-66.8 19.3L272 512z"/></svg> <span> Ver solo la traducción española</span></button></div>
	<div id="lienTransc"></div>
	<p style="font-size: .9rem;">A continuación se brindan cuatro modos de consulta para esta carta: el manuscrito original o la más antigua copia manuscrita que se conoce, la edición de Jules Bonnet publicada en 1854, una versión en francés moderno y una traducción al español que puede explorar y comparar. Solo necesita clicar sobre los botones para abrir (o cerrar) las secciones. También puede cambiar el orden de las secciones.</p>
	<!-- Interface container-->
